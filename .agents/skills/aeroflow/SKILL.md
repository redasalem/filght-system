---
name: aeroflow-flight-engine
description: Engineering constraints and standards for AeroFlow flight booking system (Redis seat locking, Stripe webhook idempotency, and pgvector search).
---
